...
export default class BankCardUpdate extends React.Component {
  constructor(props) {
    super(props);
  }
...
class FormComponent extends React.Component {
  ...
  componentDidMount() {
    this.handleBankCard(this.props.cardId);
  }
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        >
          {getFieldDecorator('ftype', {
            rules:[{ required: true, message: '如果没有银行卡，请返回页面重新跳转' }],
