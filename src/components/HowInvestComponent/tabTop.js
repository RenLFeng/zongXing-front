            ...
            <div className="w">
              <div className="item shadow fensan">
                ...
                <div className="bd">
                  ...
                  <p className="list-info">借款的用户分散在不同的地域、行业、年龄区间，确保这些项目的独立性，相互之间没有影响。的个体之间违约的概率能够相互保持独立性，则同时违约的概率就会非常小。</p>
                  <p className="dot">借款的个体之间分散独立<i className="i"></i></p>
                  <p className="list-info">分散、独立的借款个体，违约的概率能够保持独立性，则同时违约的概率就会非常小。</p>
                  <p className="dot">分散大大降低违约概率<i className="i"></i></p>
                  <p className="list-info">在保持借款个体独立性的基础上，分散可以系统性大大降低风险。</p>
              ...
              <div className="item shadow xiaoe">
                ...
                <div className="bd">
                  ...
                  <p className="list-info">单个项目借款不超过100万，是中国《网络借贷信息中介机构业务活动管理暂行办法》中的规定。</p>
                  <p className="dot">单个人最多能投资一个项目的1%<i className="i"></i></p>
                   <p className="list-info">保证每个借款项目有100个以上的投资人，系统性大大降低一个人在单个项目中的投资风险。</p>
                  <p className="dot">小额投资，实现尽量分散<i className="i"></i></p>
                   <p className="list-info">系统性控制你在单个项目上的投资金额，让你有限的投资总额尽可能多的分散投资在更多的项目上。</p>
                  <p className="dot">小额分散，避免小样本偏差<i className="i"></i></p>
                   <p className="list-info">“小样本偏差”：例如，平台1年累计做100亿元的借款，如果借款人平均每人借50万，就有20000个客户；如果每个借款人平均借款1000万，那么只有1000个客户。
