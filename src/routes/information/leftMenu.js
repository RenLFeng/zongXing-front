...
export default class LeftMenu extends React.Component {
  ...
  componentDidMount(){
    ...
    if(path.indexOf('companyIntroduction')!==-1){
    ...
    return (
      <div className="fl shadow center infor">
        ...
        <p className="t1"><Icon type="idcard" />关于我们</p>
             ...
             <p className={'t2 '+(this.state.company?this.state.company:"")}><Link  className={path.indexOf(Path.COMPANY_INTRODUCTION) ===-1?'':'hover'} to={Path.COMPANY_INTRODUCTION}>公司介绍</Link></p>
