        ...
        <div className="section sec-qa">
           <div className="w clearfix">
            <div className="fl shadow center">
             ...
             <p className="t1"><Link  to={`${match.path}/projectInformation`}><Icon type="idcard" />关于我们</Link></p>
             ...
             <p className="t2"><Link  to={`${match.path}/projectInformation`}>联系我们</Link></p>
              <p className="t2"><Link  to={`${match.path}/plantNotice`}>平台公告</Link></p>

             <p className="t1"><Link  to={`${match.path}/projectInformation`}><Icon type="team" />合作伙伴</Link></p>
          ...
          <Switch>
            ...
            <Route path={`${match.path}/plantNotice`} component={Plant} />
          </Switch>
      </div>
    </div>
